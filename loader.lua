...
local function loadbloxfruits()
	...
	rs.Heartbeat:Connect(function()
		...
		if autoken then if not lighting.ColorCorrection.Enabled then asssupercock.Remotes['CommE']:FireServer('Ken',true)lighting.ColorCorrection.Enabled=true end end
